...
?>
	...
	<div class="col-12 col-lg-4">
		<div class="card d-block p-3 mb-4">	
			...
			<p class="mb-0"><a href="<?php the_permalink();?>" class="btn btn-dark text-white my-2"><?php esc_html_e('Read More' , 'bootstrap-component-blox');?></a>
			<?php wp_link_pages();?>
		</div>
	</div>
