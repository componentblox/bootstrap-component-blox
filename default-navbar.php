<nav class="navbar-light navbar navbar-expand-lg <?php echo $navbar_classes;?> py-0">
	<div class="container-fluid <?php echo $navbar_inner_classes;?>">
    	...
    	<button id="toggler" class="navbar-toggler collapsed border-0" type="button" data-toggle="collapse" data-target="#navbarIcon" aria-controls="navbarIcon" aria-expanded="false" aria-label="Toggle navigation">
