...
get_template_part('footer-widgets');?>
	...
	<footer class="text-center py-3 <?php echo esc_html($footer_classes);?>" role="contentinfo">
		<div class="site-info"><?php if($footer_credit){echo esc_html($footer_credit);} else {?>&copy;<?php echo esc_html(date('Y'));?> Copyright <a href="https://theme.componentblox.com"><?php bloginfo('name'); ?></a>. <?php esc_html('Powered by ', 'bootstrap-component-blox'); ?><a href="//wordpress.org" title="WordPress">WordPress</a> &amp; <a href="//getbootstrap.com/" title="Bootstrap"> Bootstrap</a>.<?php }?></div>
	</footer>
    <?php wp_footer(); ?>
