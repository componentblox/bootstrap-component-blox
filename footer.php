	...
	<footer class="text-center py-3 <?php echo $footer_classes;?>" role="contentinfo">
		<div class="site-info">
			...
			if($footer_credit) {
				...
				&copy; <?php echo date('Y'); ?> Copyright <a href="https://wp-bootstraptheme.com">
					<?php bloginfo('name'); ?></a>. <?php _e('Powered by', 'bootstrap-component-blox'); ?>
					<a href="//wordpress.org" title="WordPress">WordPress</a> &amp; <a href="//getbootstrap.com/" title="Bootstrap"> Bootstrap</a>.
		    <?php } ?>
		</div>
	</footer>
    <?php wp_footer(); ?>
