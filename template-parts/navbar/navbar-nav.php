...
<nav id="bcb-main-navbar" class="navbar-light navbar navbar-expand-lg py-0 <?php echo esc_attr(get_theme_mod('navbar_classes'));?>">
	<div class="container-fluid <?php echo esc_attr(get_theme_mod('navbar_inner_classes'));?>">
    	...
    	<button id="toggler" class="navbar-toggler pe-0 collapsed border-0" type="button" data-bs-toggle="collapse" data-bs-target="#navbar-main-menu" aria-controls="navbar-main-menu" aria-expanded="false" aria-label="Toggle Navigation">
